<html>
    <head>
        ...
        <link rel="stylesheet" href='{{url("css/home_.css")}}'>
        <link href="https://fonts.googleapis.com/css2?family=Raleway:wght@100&display=swap" rel="stylesheet">
    </head>
    <body>        
        <header>
        <div id="nome">{{ $nome }}, </br>benvenuto in </br>Cliniche MaterEtna</div>
    ...
    <section>
            <div id="scelta">Le nostre cliniche
                <a id="cliniche" class="button">Catania</a>
                <a id="cliniche" class="button">Milano</a>
                <a id="cliniche" class="button">Roma</a>
            </div>
            <div id="row">
                <div class="item">
                    <div id="image">
            ...
            <div id="row">
                <div class="item">
                    ...
                    <p>Strutture realizzate con il massimo della tecnologia </br>per soddisfare tutti i vostri bisogni.</p>
                    </div>
                </div>
                <div class="item">
                    <div id="image">
